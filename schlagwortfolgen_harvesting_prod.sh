...
$Metafacture_Runner harvestRecordsWithoutSWFFromLobid_prod.flux CATALOGUE="bvb"

echo "BVB: SRU Harvesting" && date
$Metafacture_Runner harvestRecordsFromSru_prod.flux CATALOGUE="bvb" SRU_LINK_PART_1="http://bvbr.bib-bvb.de:5661/bvb01sru?version=1.1&recordSchema=marcxml&operation=searchRetrieve&query=marcxml.idn=" SRU_LINK_PART_2="&maximumRecords=1" SRU_QUERY_PATTERN=".*marcxml.idn=(.+)"
...
$Metafacture_Runner harvestRecordsWithoutSWFFromLobid_prod.flux CATALOGUE="k10Plus"

echo "K10Plus: SRU Harvesting" && date
$Metafacture_Runner harvestRecordsFromSru_prod.flux CATALOGUE="k10Plus" SRU_LINK_PART_1="https://sru.k10plus.de/opac-de-627?version=1.1&operation=searchRetrieve&query=pica.ppn=" SRU_LINK_PART_2="&maximumRecords=1&recordSchema=marcxml" SRU_QUERY_PATTERN=".*pica.ppn=(.+)"
...
# $Metafacture_Runner harvestRecordsWithoutSWFFromLobid_prod.flux CATALOGUE="bsz"
# 
# echo "BSZ: SRU Harvesting" && date
# $Metafacture_Runner harvestRecordsFromSru_prod.flux CATALOGUE="bsz" SRU_LINK_PART_1="https://sru.k10plus.de/opac-de-627?version=1.1&operation=searchRetrieve&query=pica.swn=" SRU_LINK_PART_2="&maximumRecords=1&recordSchema=marcxml" SRU_QUERY_PATTERN=".*pica.swn=(.+)"
#  
...
# $Metafacture_Runner harvestRecordsWithoutSWFFromLobid_prod.flux CATALOGUE="kobv"
# 
# echo "KOBV: SRU Harvesting" && date
# $Metafacture_Runner harvestRecordsFromSru_prod.flux CATALOGUE="kobv" SRU_LINK_PART_1="https://sru.kobv.de/k2?version=1.1&operation=searchRetrieve&query=rec.id%3D" SRU_LINK_PART_2="&startRecord=1&maximumRecords=10&recordSchema=marcxml&recordSchema=marcxml" SRU_QUERY_PATTERN=".*rec.id=(.+)"
# 
