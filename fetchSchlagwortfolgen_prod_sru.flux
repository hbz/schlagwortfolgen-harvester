...
default AUTH ="";
default SRU_HARVEST=FLUX_DIR + VERSION + "/harvest/" + CATALOGUE + "_sru_records.xml.gz";
default OUTFILE=FLUX_DIR + VERSION + CATALOGUE + "Subjects.xml.gz";
default LOBID_HARVEST = FLUX_DIR + VERSION +"/harvest/"  + CATALOGUE + "LobidWithoutSchlagwortfolge.jsonl.gz";
